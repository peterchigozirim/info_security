...
$date =date('Y-m-d');
	...
	$database->query('INSERT INTO `foodtaken` (foodname, qty, foodtype,qtytaken,date) VALUES (:food,:qty, :foodtype, :qtytaken, :date)');
	...
	if($sent){
		$success = "Food Taken has been Recorded";
	}else{
...
<html lang="en">
  ...
  <body class="app sidebar-mini rtl">
    ...
    <main class="app-content">
      <div class="app-title">
        <div>
          <h1><i class="fa fa-edit"></i>Food Taken</h1>
        </div>
        <ul class="app-breadcrumb breadcrumb">
          <li class="breadcrumb-item"><i class="fa fa-home fa-lg"></i></li>
          <li class="breadcrumb-item"><a href="admin.php">Dashboard</a></li>
          <li class="breadcrumb-item">Food Taken</li>
        </ul>
      </div>
...
<tr>
          <td><label>Qty Taken:<label></td>
          <td ><input type="text" autocomplete="off" class="form-control" name="b" tabindex="2" required /></td>
        </tr>
			  <tr>
          <td><label>Food Type<label></td>
          <td ><input type="text" autocomplete="off" class="form-control" name="c" tabindex="2" required /></td>
        </tr>
