...
$id = $_GET['id'];
	$database->query('SELECT * FROM expenditure WHERE id = :id');
    $database->bind(':id', $id);
    $database->execute();
...
if(isset($post['submit'])){
	...
	$database->query('UPDATE `expenditure` SET title = :title, body = :body, active = :active WHERE id = :id');
	...
	if($senti){
		$msg = "Expenditure has been edited";
	}else{
	...
	$database->query('DELETE FROM expenditure WHERE id = :id');
...
<html lang="en">
  ...
  <body class="app sidebar-mini rtl">
    ...
    <main class="app-content">
      <div class="app-title">
        <div>
          <h1><i class="fa fa-edit"></i> Edit Expenditure</h1>
        </div>
        <ul class="app-breadcrumb breadcrumb">
         <i class="fa fa-home fa-lg"></i>
          <li class="breadcrumb-item"><a href="addreg.php">Add Expenditure</a></li>
		  <li class="breadcrumb-item"><a href="show.php">Groceries</a></li>
          <li class="breadcrumb-item">Edit Expenditure</li>
        </ul>
      </div>
      <?php if(isset($msg)){ ?><center><p class="btn btn-info" id="demoNotify"><?php echo $msg; ?></p></center><?php } ?><div class="row">
        <div class="col-md-12">
          <div class="tile">
            <h3 class="tile-title">Edit Expenditure</h3>
            <div class="tile-body">
